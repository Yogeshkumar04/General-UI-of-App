...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        * Here the activity is displayed for 2 seconds and then the Handler starts the new process after 2 second
        ...
        * We use finish() here so the when the user presses back button, it is not redirected to this activity
        * */
